...
import integrationLogRoutes from './routes/integration-log.routes';
...
async function startServer(): Promise<void> {
  ...
  app.get('/health', (_req, res) => {
    res.json(successResponse({ status: 'healthy', service: 'audit-service' }));
  });

  app.use('/audit', auditRoutes);
  app.use('/audit/integration-logs', integrationLogRoutes);
