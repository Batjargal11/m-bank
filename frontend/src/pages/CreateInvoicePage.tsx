      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="card space-y-5">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div>
              <label className="mb-1.5 block text-sm font-medium text-gray-700">НӨАТ дүн</label>
              <input
                type="number"
                value={vatAmount}
        ...
        <div className="card space-y-4">
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="pb-2 text-left text-xs font-semibold uppercase text-gray-500 w-24">Татвар %</th>
                  ...
                  <tr key={idx}>
                    <td className="py-2 pr-2">
                      <input
                        ...
                        className="input-field"
                        placeholder="Бүтээгдэхүүн / Үйлчилгээ"
                        required
                      />
                    </td>
                    <td className="py-2 pr-2">
          ...
          <div className="flex justify-end border-t border-gray-200 pt-4">
            <div className="w-64 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">НӨАТ:</span>
                <span className="font-medium">{formatAmount(vatAmount, currency)}</span>
              </div>
